                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <a href="#updateData<?= $row['quota_id'] ?>" class="btn btn-warning"
                                            data-toggle="modal" title="Update Data"><i class="fas fa-edit"></i>
                                            Update</a>
                                        <?php } ?>
                                        <?php if ($resultForPrivileges['DELETE_DATA'] == 'Y') { ?>
                                        <a href="#deleteData<?= $row['quota_id'] ?>" class="btn btn-danger"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="IdMitraUpdate<?= $row['quota_id'] ?>">Nama
                                                                        Mitra </label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="IdTahunUpdate<?= $row['quota_id'] ?>">Tahun
                                                                    </label>
                                                                    <select type="text"
                                                                        class="default-select2 form-control"
                                                                        name="UpdateTahun"
                                                                        id="IDTahunUpdate<?= $row['quota_id'] ?>">
                                                            ...
                                                            <!-- Golongan A -->
                                                            <div class="col-md-12"
                                                                style="background: #348fe2;display: flex;justify-content: center;align-items: center;padding: 10px 0 0 10px;margin-bottom: 10px;color: #fff;font-size: 14px;font-weight: 700;border-radius: 5px;">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="UpdateGol_A" value="GOL A" readonly>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control"
                                                                        name="UpdateKuotaCARTON_A" id="IdKuotaCARTON_A"
                                                                        placeholder="Kuota CARTON"
                                                                        value="<?= $row['gol_a_car'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control"
                                                                        name="UpdateKuotaLITER_A" id="IdKuotaLITER_A"
                                                                        placeholder="Kuota LITER"
                                                                        value="<?= $row['gol_a_ltr'] ?>">
                                                                </div>
                                                            </div>
                                                            <!-- End Golongan A -->
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="UpdateGol_B" value="GOL B" readonly>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="IdCARTON">CARTON </label>
                                                                    <input type="number" class="form-control"
                                                                        name="UpdateKuotaCARTON_B" id="IdKuotaCARTON_B"
                                                                        placeholder="Kuota CARTON"
                                                                        value="<?= $row['gol_b_car'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="IdLITER">LITER </label>
                                                                    <input type="number" class="form-control"
                                                                        name="UpdateKuotaLITER_B" id="IdKuotaLITER_B"
                                                                        placeholder="Kuota LITER"
                                                                        value="<?= $row['gol_b_ltr'] ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="UpdateGol_C" value="GOL C" readonly>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="IdCARTON">CARTON </label>
                                                                    <input type="number" class="form-control"
                                                                        name="UpdateKuotaCARTON_C" id="IdKuotaCARTON_C"
                                                                        placeholder="Kuota CARTON"
                                                                        value="<?= $row['gol_c_car'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="IdLITER">LITER </label>
                                                                    <input type="number" class="form-control"
                                                                        name="UpdateKuotaLITER_C" id="IdKuotaLITER_C"
                                                                        placeholder="Kuota LITER"
                                                                        value="<?= $row['gol_c_ltr'] ?>">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="alert alert-danger m-b-0">
                                                        ...
                                                        <p>Anda tidak akan melihat data ini lagi, data akan di hapus
                                                            secara permanen pada sistem informasi TPB!<br><i>"Silahkan
                                                                ...
                                                                data."</i></p>
                                                        <input type="hidden" name="DeleteMitra"
                                                            value="<?= $row['NAMA'] ?>">
                                                        <input type="hidden" name="DeleteTahun"
                                                            value="<?= $row['quota_year'] ?>">
                                                        <input type="hidden" name="IDUNIQ"
                                                            value="<?= $row['quota_id'] ?>">
                                                    </div>
                                                </div>
