    ...
    <div class="page-title-css">
        <div>
            <h1 class="page-header-css">
                ...
                <font class="text-page">Filter Tabel DB</font>
            </h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index_viewonline.php">View Data Online</a></li>
                <li class="breadcrumb-item active">Filter Tabel DB</li>
            </ol>
        </div>
        <div>
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="ui-icons-1">
                <div class="panel-heading">
                    <h4 class="panel-title"><i class="fas fa-info-circle"></i> Filter DB Tabel TPB</h4>
                    ...
                    <form action="tbl_tpb.php" method="GET">
                        <fieldset>
                            <div class="form-group row m-b-15">
                                <label class="col-md-3 col-form-label">Pilih Tabel <font style="color: red;">*</font></label>
                                <div class="col-md-7">
                    ...
                    <?php if ($TableName != NULL) { ?>
                        ...
                        <div class="note note-secondary">
                            ...
                            <div class="note-content">
                                ...
                                <?php if ($FindLimit == NULL) { ?>
                                    <p> Anda menampilkan total data kesuluran <b><?= $ResultTotalDataAll['total_data_all']; ?> data</b></p>
                                <?php } else { ?>
                                    <p> Anda menampilkan total data sebanyak <b><?= $FindLimit ?> data</b> dari total data kesuluran <b><?= $ResultTotalDataAll['total_data_all']; ?> data</b></p>
                                <?php } ?>
                            </div>
                        </div>
                        <!-- End Alert -->
